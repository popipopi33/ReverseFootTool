...
def reverse_foot_setup_main():
    ...
    adjust_tr("toe_bindJNT", "toe_ctrl")
    adjust_tr("ball_bindJNT", "reverseBall_ctrloffB")

    adjust_ro('ankleTop_bindJNT', 'ankleTop_ik_JNT')
    adjust_ro('toe_bindJNT', 'toe_ik_JNT')
    adjust_ro('ball_bindJNT', 'ball_ik_JNT')
    ...
    adjust_tr('ankle_bindJNT', 'ankle_root_ik_JNT')
    ...
    cmds.orientConstraint('ankle_bindJNT', 'ankle_ctrl', mo=True)
    cmds.orientConstraint('ball_ik_JNT', 'reverseToe_JNT', mo=True)
    cmds.orientConstraint('ball_ik_JNT', 'reverseToe_ctrl', mo=True)
    cmds.orientConstraint('reverseBall_JNT', 'reverseBall_ctrl', mo=True)
    cmds.orientConstraint('ankle_root_ik_JNT', 'reverseBall_JNT', mo=True)
    cmds.orientConstraint('reverseToe_JNT', 'reverseToe_ctrl', mo=True)
    cmds.orientConstraint('reverseHeel_JNT', 'reverseHeel_ctrl', mo=True)
